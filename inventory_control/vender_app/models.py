...
class vender_master(models.Model):
    id = models.AutoField(auto_created = True,primary_key = True,)
    vender_name = models.CharField(max_length=255,default=None)
    ...
    vender_manager_name= models.CharField(max_length=255,default=None)
    vender_manager_contact_number = models.CharField(max_length=255,default=None)
